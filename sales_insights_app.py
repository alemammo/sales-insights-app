...
payment_time_filter = st.selectbox(
    "Show clients based on average payment time:", 
    ['30 days or less', '31 to 45 days', '46 to 60 days', 'Above 60 days']
)
...
elif payment_time_filter == 'Above 60 days':
    filtered_clients = clients_avg_payment_time[clients_avg_payment_time['Days \'til Paid'] > 60]
